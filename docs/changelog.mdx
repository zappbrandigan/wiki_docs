...
### Added
- Search & replace preview mode with a dedicated **Show/Hide Preview** toggle. (d2bc670)
- Per-rule impact badges (affected files, empty search, invalid regex). (d2bc670)
- **Undo Last Apply** for search/replace operations. (d2bc670)
- Match highlighting in filename previews, including capture-group highlighting. (d2bc670)
- Loading overlays for large file uploads and IndexedDB hydration. (d2bc670)

### Changed
- PDF table layout adapts in preview mode by hiding non-essential columns to reduce crowding. (d2bc670)

### Fixed
- Dark mode invalid-regex input styling now preserves readable text contrast.
