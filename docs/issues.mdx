...
<BugCard
  id="#007"
  tool="CWR Converter"
  summary="Reports imcomplete on certain files"
  date="2025-08-06"
  appVersion="3.4.3"
  platform="Chrome"
  area="CWR Converter"
...
#### Fix Summary:  
* Ensures reports include the complete CWR file.  

**Original Issue:**  
Reports in the CWR Converter tool showed incomplete data for specific CWR files.

**Verification:**  
1. Load problem CWR file.  
2. Generate any report.  
3. Confirm that not all data is present.
